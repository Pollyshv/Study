...
for (let i = 0; i < liCollection.length; i++) {
    console.log(liCollection[i].textContent); // дз 7 номер 1
...
console.log(liElement); // дз 7 номер 2
...
console.log(linkElement); // дз 7 номер 3
...
document.body.appendChild(imgClone) // дз 7 номер 4 